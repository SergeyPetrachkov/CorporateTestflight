...
struct JiraViewerStoreTests {
	...
	@Test(
		arguments: [
			...
			Ticket(id: UUID(uuidString: "00000000-0000-0000-0000-000000000001")!, key: "Jira-1", title: "Title1", description: "Description1", attachments: [])
		]
	)
	...
	@Test(
		arguments: [
			Ticket(id: UUID(uuidString: "00000000-0000-0000-0000-000000000001")!, key: "Jira-1", title: "Title1", description: "Description1", attachments: ["meme.jpg"]),
			Ticket(id: UUID(uuidString: "00000000-0000-0000-0000-000000000001")!, key: "Jira-1", title: "Title1", description: "Description1", attachments: ["meme.jpg", "meme1.jpg"])
		]
	)
	func validTicketWithAttachmentsShouldLoadDataAndResultInLoadedState(ticket: Ticket) async {
		let env = Environment()
		let expectedImage = LoadableImage()
		let expectedLoadedImages = ticket
			.attachments?
			.compactMap { JiraViewer.LoadedImage(
				resourceURL: URL(string: "http://localhost:8080/images/\($0)")!, image: expectedImage)
			} ?? []
